 ...
 function marquee(box, content, direction, speed) {
        ...
        div.style.minHeight = box.offsetHeight + "px";
        div.style.minWidth = box.offsetWidth + "px";
        container.appendChild(div);

        var div2 = document.createElement('div');
        div2.innerHTML = content;
        div2.style.minHeight = box.offsetHeight + "px";
        div2.style.minWidth = box.offsetWidth + "px";
